...
namespace NonGenericMethodExample
{
    class NonGenericMethods
    {
        static void Main(string[] args)
        {
            ...
            DisplayArray(charArray, "Centennial"); // pass a char array argument
        }
        ...
        private static void DisplayArray<T>(T[] inputArray, T index)
        {
            foreach (var element in inputArray)
            {
                Console.Write($"{element} ");
        ...
        private static void DisplayArray<T1, T2>(T1[] inputArray, T2 index)
        {
            foreach (var element in inputArray)
            {
                Console.Write($"{element} ");
